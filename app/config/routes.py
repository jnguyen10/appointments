...
routes['POST']['/appointments/new'] = 'Appointments#new'
routes['GET']['/appointments/edit/<int:id>'] = 'Appointments#edit'
routes['POST']['/appointments/update/<int:id>'] = 'Appointments#update'
"""
